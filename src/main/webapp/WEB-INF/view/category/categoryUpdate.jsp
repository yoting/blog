...
<script type="text/javascript">
	function selectParent() {
		...
		$.layer({
			...
			maxmin : true,
			iframe : {
				src : '${ctx}/category/categoryTreeView?id=${category.id}'
			},
			area : [ '800px', '500px' ],
...
<body>
	...
	<div>
		<form:form action="${ctx }/category/updateCategory" method="post"
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					...
					<div class="input-group">
						<input type="text" id="parentCategoryInfo"
							value="${category.parentCategory.name }" disabled="disabled"
							class="form-control" placeholder="请输选择"> <span
